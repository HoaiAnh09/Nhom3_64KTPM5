...
# Thử nhiều tham số cho n_estimators
...
for n_estimators in n_estimators_list:
    stacking_model = StackingRegressor(
        ...
        final_estimator=RandomForestRegressor(n_estimators=n_estimators, max_depth=10, random_state=42)
    )
...
st.subheader("Kết quả cho các giá trị n_estimators")
...
if st.button("Dự đoán"):
    ...
    best_stacking_model = StackingRegressor(
        estimators=estimators,
        final_estimator=RandomForestRegressor(n_estimators=100, max_depth=10, random_state=42)  # Sử dụng giá trị n_estimators = 100
    )
